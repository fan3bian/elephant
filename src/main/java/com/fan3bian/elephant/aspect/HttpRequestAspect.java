...
public class HttpRequestAspect {
    ...
    /*切点表达式*/
    @Pointcut("execution(public * com.fan3bian.elephant.controller.*.*(..))")
    /*切点签名*/
    public void print() {
    ...
    public void before(JoinPoint joinPoint) {
        ...
        log.info("请求url=" + requestURI + ",客户端ip=" + remoteAddr + ",请求方式=" + requestMethod + ",请求的类名=" + declaringTypeName + ",方法名=" + methodName + ",入参=" + Arrays.toString(args));
    }
...
//        log.info(object.getClass().toGenericString());
