 ...
 * Kryo Utils
 * <p/>
 * Created by hanwenyang on 2017-5-13.
 */
public class KryoUtil {
     ...
     * 将字节数组反序列化为原对象
     *
     * @param byteArray writeToByteArray 方法序列化后的字节数组 null时抛出异常
     * @param <T>       原对象的类型
     * @return 原对象
     */
    @SuppressWarnings("unchecked")
    public static <T> T readFromByteArray(byte[] byteArray) throws IllegalArgumentException {
        if (byteArray == null) throw new IllegalArgumentException("input cannot be null.");
